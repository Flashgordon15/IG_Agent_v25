"""
Heavy API routers — imported only after Uvicorn binds (lazy router mount).

Do not import this module from ``api.server`` at load time.
"""
...
def _dashboard_dist() -> Path:
    from api.server import resolve_dashboard_dist
