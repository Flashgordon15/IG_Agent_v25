...
rm -f "${LAUNCH_AGENTS}/${AGENT_PLIST}" "${LAUNCH_AGENTS}/${CAFF_PLIST}" "${LAUNCH_AGENTS}/${WATCHDOG_PLIST}"

echo "Unloaded and removed ${AGENT_PLIST}, ${CAFF_PLIST}, and ${WATCHDOG_PLIST}"
