/**
 * Mirrored from repo-root QUANTUM_ROUTER_AUDIT.md.
 * Static string — client modal never hits agent PID or disk.
 */

export const QUANTUM_ROUTER_AUDIT_MD = `# QUANTUM ROUTER AUDIT — Multi-Market Deployment Blueprint
...
export const ROUTER_AUDIT_BUTTON_LABEL =
  "📋 EXPOSE MULTI-MARKET DEPLOYMENT BLUEPRINT";
