/**
 * Permanent architectural truth — mirrored from repo-root QUANTUM_NODE_STATUS_QUO.md.
 * Imported as a static string so the client modal never hits the agent PID or disk.
 */

export const QUANTUM_NODE_STATUS_QUO_MD = `# 📊 QUANTUM ENGINE SYSTEM ARCHITECTURE & STRATEGIC BLUEPRINT
...
export const BLUEPRINT_BUTTON_LABEL =
  "⚙️ PLATFORM ARCHITECTURE & AUDIT BLUEPRINT";
