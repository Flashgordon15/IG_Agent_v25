# Daily Operator Digest — 2026-06-11

*Generated Thursday 11 Jun 2026, 07:30 BST*

## At a glance

| | |
|---|---|
| Roadmap progress | **48%** · milestone **M0** |
| Agent running | **No — start before sessions** |
| Demo soak | **ON** |
| 14d P&L | **£+33.83** · WR **30.8%** · 26 closes |
| Today (feeder) | trade_ready **130** · intents **0** · closes **0** |
| ML training rows | **0** (target 500+) |
| Top gate blocker (7d) | **session_open** (72%) |
...
L0 [PASS] 100% — P&L audit: Rolling expectancy snapshot from feeder fills · L1 [INSUFFICIENT] 35% — Soak 14d: 5/14 soak days · median £0.0 · L2 [PASS] 100% — Walk-forward: 6/6 epics with threshold curve
...
- **Baseline:** ~1.9 closes/day from 14d ledger (recent active days were 8–10).
